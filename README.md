...
This repository includes a CSV file with data from participants responses to different questions. These questions include:
...
The _frame-works_ that were being refered to are:
...
The CSV file also includes other datapoints concerning the participants.
